...
-- Policy: Artists can manage their own bookings
CREATE POLICY "Artists can manage their own bookings"
  ON bookings FOR ALL
  USING (auth.uid() = artist_id);

-- Policy: Public can view available bookings
...
-- Policy: Artists can manage their booking images
...
-- Policy: Public can view booking images
...
-- Policy: Admins can manage all booking images
...
-- Policy: Allow artists to upload booking images
...
-- Policy: Allow public to view booking images
CREATE POLICY "Public can view booking images"
  ON storage.objects FOR SELECT
  USING (bucket_id = 'booking-images');

-- Policy: Allow artists to update their booking images
...
-- Policy: Allow artists to delete their booking images
